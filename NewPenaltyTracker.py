...
class PenaltyTracker:
    ...
    def __init__(self):
        ...
        if self.databaseLocation != "" and self.timePeriod != "":
            self.databaseManager = self.createDatabaseManager()
        else:
    ...
    def createDatabaseManager(self):
        try:
            ...
            return DatabaseManager(self.databaseLocation, self.timePeriod);
